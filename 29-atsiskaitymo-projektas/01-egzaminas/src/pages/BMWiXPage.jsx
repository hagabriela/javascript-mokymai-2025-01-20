...
import styles from "./BMWiXPage.module.css"

import car from "./images/bmwX.png"
...
const BMWiXPage = () => {
    ...
    const [selectedColor, setSelectedColor] = useState("Raudona");
    ...
    const [totalPrice, setTotalPrice] = useState(100700);
