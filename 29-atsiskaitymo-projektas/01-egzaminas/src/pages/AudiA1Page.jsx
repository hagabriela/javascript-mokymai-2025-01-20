...
import styles from "./AudiA1Page.module.css"

import car from "./images/audiA.png"
...
const AudiA1Page = () => {
    ...
    const [selectedColor, setSelectedColor] = useState("Pilka");
    ...
    const [totalPrice, setTotalPrice] = useState(50200);
