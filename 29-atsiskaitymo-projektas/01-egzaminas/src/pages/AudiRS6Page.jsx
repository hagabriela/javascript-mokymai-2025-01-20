...
import styles from "./AudiRS6Page.module.css"

import car from "./images/audiR.png"
...
const AudiRS6Page = () => {
    ...
    const [selectedColor, setSelectedColor] = useState("Melyna");
    ...
    const [totalPrice, setTotalPrice] = useState(54350);
